...
<div class="container">
    ...
    <?php foreach($agenda as $modify){?>
        ...
        <input type="text" name="id_agenda" value="<?php echo utf8_decode($modify->id_agenda) ?>" />
        <br />
        ...
        <br />
        <input name="image" type="file" accept=".png,.jpg,.jpeg"  multiple value="<?php echo $modify->image ?>"  />
        <br />
        <input type="submit" />
        <?php }?>
    </form>
